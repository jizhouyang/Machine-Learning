...
def main(main_params):
    ...
    for t in range(num_epoch):
        ...
        for i in range(int(np.floor(N_train / minibatch_size))):
            ...
            # TODO (2)
            Conv2 = model['C2'].forward(m1)
            ReLu2 = model['nonlinear2'].forward(Conv2)
            MaxPool2 = model['M2'].forward(ReLu2)
            ################################################################################
            #                            End of TODO (2)                                   #
            ################################################################################

            f1 = model['F1'].forward(MaxPool2)
            ...
            grad_m2 = model['F1'].backward(MaxPool2, grad_f1)
            ...
            # TODO (3)
            grad_ReLu2 = model['M2'].backward(ReLu2, grad_m2)
            grad_Conv2 = model['nonlinear2'].backward(Conv2, grad_ReLu2)
            grad_m1 = model['C2'].backward(m1, grad_Conv2)
            ################################################################################
            #                            End of TODO (3)                                   #
            ################################################################################
